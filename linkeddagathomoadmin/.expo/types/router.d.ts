...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/modal` | `/new-post` | `/profile` | `/search`;
  type DynamicRoutes<T extends string> = `/posts/${SingleRoutePart<T>}` | `/users/${SingleRoutePart<T>}`;
  type DynamicRouteTemplate = `/posts/[id]` | `/users/[id]`;
